...
async function main() {
  console.log("🌱 Seeding DSV Demo Data...\n");
  ...
  for (const email of emails) {
    await prisma.email.create({
      data: {
        ...
        toEmail: "airfreight.ops@dsv.com",
        ...
        assignedRepEmail: typeof email.assignedRep === 'string' ? `${email.assignedRep.toLowerCase().replace(/\s+/g, '.')}@dsv.com` : null,
  ...
  console.log("\n✨ DSV Demo data seeded successfully!");
}
